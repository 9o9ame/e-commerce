<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{asset('assets/images/user1.png')}}" class="logo-icon" alt="logo icon">
        </div>
        <div>
    ...
    <ul class="metismenu" id="menu">
        <li>
            ...
            <ul>
                <li> <a href="{{route('dashboard.index')}}"><i class="bx bx-right-arrow-alt"></i>Default</a>
                </li>
                <li> <a href="{{route('alternate')}}"><i class="bx bx-right-arrow-alt"></i>Alternate</a>
                </li>
            </ul>
        </li>
        {{-- <li>
            ...
            <ul>
                <li> <a href="{{route('email-box')}}"><i class="bx bx-right-arrow-alt"></i>Email</a>
                </li>
                <li> <a href="{{route('chat-box')}}"><i class="bx bx-right-arrow-alt"></i>Chat Box</a>
                </li>
                <li> <a href="{{route('file-manager')}}"><i class="bx bx-right-arrow-alt"></i>File Manager</a>
                </li>
                <li> <a href="{{route('app-contact-list')}}"><i class="bx bx-right-arrow-alt"></i>Contatcs</a>
                </li>
                <li> <a href="{{route('app-to-do')}}"><i class="bx bx-right-arrow-alt"></i>Todo List</a>
                </li>
                <li> <a href="{{route('app-invoice')}}"><i class="bx bx-right-arrow-alt"></i>Invoice</a>
                </li>
                <li> <a href="{{route('app-fullcalender')}}"><i class="bx bx-right-arrow-alt"></i>Calendar</a>
                </li>
            </ul>
        </li> --}}
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{route('ecommerce-products')}}"><i class="bx bx-right-arrow-alt"></i>Products</a>
                </li>
                <li> <a href="{{route('ecommerce-products-details')}}"><i class="bx bx-right-arrow-alt"></i>Product
                        Details</a>
                </li>
                <li> <a href="{{route('ecommerce-add-new-products')}}"><i class="bx bx-right-arrow-alt"></i>Add New
                        Products</a>
                </li>
                <li> <a href="{{route('ecommerce-orders')}}"><i class="bx bx-right-arrow-alt"></i>Orders</a>
                </li>
            </ul>
        </li>
        {{-- <li>
